...
def run_analytics_pipeline():
    ...
    analytics = {
        ...
        'total_token_used': int(df['TokenUsed'].sum()) if not df.empty else 0,
        'top_faculty_token_usage': df.groupby('Faculty')['TokenUsed'].sum().sort_values(ascending=False).to_dict(),
        'top_department_usage': df['Department'].value_counts().head(10).to_dict(),
        ...
        'app_usage_counts': df['AppUsed'].value_counts().to_dict(),
